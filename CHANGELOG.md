...
## [1.8.1](https://github.com/upwindsecurity/terraform-oci-onboarding/compare/v1.8.0...v1.8.1) (2026-05-12)

### Bug Fixes

* **AG-8744:** added block execution validation for id and secret fields ([#46](https://github.com/upwindsecurity/terraform-oci-onboarding/issues/46)) ([4618c88](https://github.com/upwindsecurity/terraform-oci-onboarding/commit/4618c88f93bca3a13be5db6c56371055e27ddc07)), closes [#44](https://github.com/upwindsecurity/terraform-oci-onboarding/issues/44)

## [1.4.3](https://github.com/upwindsecurity/terraform-oci-onboarding/compare/v1.4.2...v1.4.3) (2026-02-24)

### Bug Fixes

* **AG-0:** trigger release with comment ([#34](https://github.com/upwindsecurity/terraform-oci-onboarding/issues/34)) ([5470796](https://github.com/upwindsecurity/terraform-oci-onboarding/commit/547079626dfef25de00ccf11d1de57ac642aa525))
...
* **AG-4420:** fix default domain name ([#28](https://github.com/upwindsecurity/terraform-oci-onboarding/issues/28)) ([aa3cfde](https://github.com/upwindsecurity/terraform-oci-onboarding/commit/aa3cfdee1570c64582a115792af92d2647fe55a7))
...
* **AG-0:** vault fixes, use groups rather than dynamic groups for deployment/reader ([#9](https://github.com/upwindsecurity/terraform-oci-onboarding/issues/9)) ([754bb8e](https://github.com/upwindsecurity/terraform-oci-onboarding/commit/754bb8ea2ccd84f003743d7cc5b4fec574308683))

## [1.1.0](https://github.com/upwindsecurity/terraform-oci-onboarding/compare/v1.0.2...v1.1.0) (2025-12-09)

### Features

* **AG-0:** provide own vault/vault encryption key, various fixes ([#7](https://github.com/upwindsecurity/terraform-oci-onboarding/issues/7)) ([1ef07d6](https://github.com/upwindsecurity/terraform-oci-onboarding/commit/1ef07d61df65105e8381e8638088da28dccb4e62))

## [1.0.2](https://github.com/upwindsecurity/terraform-oci-onboarding/compare/v1.0.1...v1.0.2) (2025-11-28)

### Bug Fixes

* **PE-6545:** fix IDCS outputs ([#5](https://github.com/upwindsecurity/terraform-oci-onboarding/issues/5)) ([cc98b28](https://github.com/upwindsecurity/terraform-oci-onboarding/commit/cc98b2895596e72be135fc231bdb8b1ee7afaed8))
